...
START: JMP BEGIN
	...
	MEMORY_F db 13, 10, "Memory freed$"
	MEMORY_ISNT_F db 13, 10, "Memory is not freed$"
	MEMORY_REQUEST_TRUE db 13, 10, "Memory has been allocated$"
	MEMORY_REQUEST_FALSE db 13, 10, "Memory has not been allocated$"
